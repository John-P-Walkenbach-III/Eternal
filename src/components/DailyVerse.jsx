...
function DailyVerse() {
    ...
    if (loading) return <div className="daily-verse-container"><p>Loading inspirational verse...</p></div>;
    if (error) return <div className="daily-verse-container"><p className="status-message error">Could not load verse. Please try again later.</p></div>;
