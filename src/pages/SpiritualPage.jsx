...
function SpiritualPage() {
  ...
  useEffect(() => {
    const fetchResources = async () => {
      ...
      setError(null);
      try {
        const querySnapshot = await getDocs(collection(db, "spiritualResources"));
  ...
  return (
    <div className="resource-page-container">
      <div className="resource-page-header">
        <FaCross className="resource-page-icon" />
        <h1>Spiritual Guidance & Mentoring</h1>
        ...
        {!loading && !error && (
          <p className="resource-page-subtitle">
            Explore resources for spiritual guidance, mentorship, and deepening your faith.
          </p>
        )}
      </div>
